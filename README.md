...
This example demonstrates how to use SQL via JDBC along with Camel's REST DSL to expose a RESTful API. Based on the original Fabric8 example, https://github.com/fabric8-quickstarts/spring-boot-camel-rest-sql. Using Camel Main instead of Spring Boot.
